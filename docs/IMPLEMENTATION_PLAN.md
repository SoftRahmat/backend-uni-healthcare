...
| 8     | Prescriptions                        | FR-PRESCRIPTION-001 through FR-PRESCRIPTION-007                                | In progress |
| 9     | Reviews and ratings                  | FR-REVIEW-001 through FR-REVIEW-007                                            | In progress |
...
| 2026-08-24 | 8            | Prescription/medicine/version persistence, completed-appointment and issuing-doctor rules, 30-day/admin-override updates, role-scoped detail/history, QR/watermarked private PDFs, email copies, seven-day reminders, doctor statistics, admin dashboard, appointment detail integration, documentation, and focused tests implemented. Live database/S3/email PDF acceptance checks remain.                           |
| 2026-08-25 | 9            | Review/response persistence, verified appointment eligibility, update/delete windows, moderation flags, atomic doctor-rating visibility, public cached discovery, patient history, permanent doctor responses, analytics, notifications, one-time booking discounts, documentation, README index, and focused tests implemented. Live database/email/concurrency acceptance checks remain.                             |
| 2026-08-27 | Support      | Guest and optionally authenticated support-ticket submission implemented with strict validation, persisted ticket status, user linkage, privacy-conscious audit metadata, migration, API documentation, and focused tests. Live-database migration acceptance remains.                                                                                                                                                 |
