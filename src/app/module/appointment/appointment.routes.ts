...
appointmentRouter.get(
  ...
  validate({ query: adminAppointmentQuerySchema }),
  searchAppointments,
);
appointmentRouter.get(
  "/patient/:patientId",
  authorizeExact("PATIENT", "ADMIN", "SUPER_ADMIN"),
  validate({ params: patientAppointmentParamsSchema, query: patientAppointmentQuerySchema }),
  listPatientAppointments,
);
appointmentRouter.get(
  "/doctor/:doctorId",
  authorizeExact("DOCTOR", "ADMIN", "SUPER_ADMIN"),
  validate({ params: doctorAppointmentParamsSchema, query: doctorAppointmentQuerySchema }),
  listDoctorAppointments,
);
appointmentRouter.get(
  "/:appointmentId",
...
appointmentRouter.patch(
  ...
  validate({ params: appointmentIdParamsSchema, body: updateAppointmentStatusSchema }),
  updateAppointmentStatus,
);
appointmentRouter.post(
