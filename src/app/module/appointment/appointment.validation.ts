...
export const patientAppointmentQuerySchema = z
  .object({
    ...commonListFields,
  ...
  .strict()
  .refine(dateRangeValid, "Start date cannot be after end date");

export const doctorAppointmentQuerySchema = z
  .object({
    ...commonListFields,
...
export const adminAppointmentQuerySchema = z
  ...
  .refine(
    (value) =>
      value.minFee === undefined || value.maxFee === undefined || value.minFee <= value.maxFee,
    {
