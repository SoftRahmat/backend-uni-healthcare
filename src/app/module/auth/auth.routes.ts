...
authRouter.post("/resend-verification", authRateLimiter, validate({ body: emailSchema }), resendVerification);
authRouter.post("/login", authRateLimiter, validate({ body: loginSchema }), login);
authRouter.post("/forgot-password", authRateLimiter, validate({ body: emailSchema }), forgotPassword);
authRouter.post("/reset-password", authRateLimiter, validate({ body: resetPasswordSchema }), resetPassword);
authRouter.post("/change-password", authenticate, validate({ body: changePasswordSchema }), changePassword);
